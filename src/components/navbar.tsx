...
export function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile menu — full-screen overlay, completely separate from header */}
      {mobileOpen && (
        <div className="fixed inset-0 z-[60] lg:hidden">
          ...
          <div className="absolute top-0 right-0 bottom-0 w-80 max-w-[85vw] bg-white shadow-2xl flex flex-col">
            ...
            <div className="flex items-center justify-between px-6 h-[72px] border-b border-border">
              ...
              <button
                onClick={closeMobile}
                className="flex items-center justify-center w-10 h-10 rounded-xl text-dark hover:bg-gray-100 transition-colors"
            ...
            <div className="flex-1 overflow-y-auto p-6">
              ...
              <a
                href="#contact"
                onClick={closeMobile}
                className="mt-6 flex items-center justify-center rounded-xl bg-primary px-6 py-3.5 text-[17px] font-semibold text-white shadow-[0_2px_8px_rgba(37,99,235,0.25)]"
              >
                Get a Free Quote
              </a>
            </div>
